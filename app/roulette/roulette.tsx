...
import CoinRoulette from '@/components/Modals/Atividade/components/coinRoulette';
...
const RouletteComponent = () => {
  ...
  return <div className={`size-full relative`}>{showContent ? <CoinRoulette isWebView /> : <LoadingIcon />}</div>;
};
